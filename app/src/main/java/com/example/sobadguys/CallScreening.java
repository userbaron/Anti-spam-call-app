...
public class CallScreening extends CallScreeningService {
    ...
    public void onScreenCall(Call.Details callDetails) {
        if (!STOP_WORKING) {
            if (callDetails.getCallDirection() == Call.Details.DIRECTION_INCOMING) {
                ...
                if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ANSWER_PHONE_CALLS) == PackageManager.PERMISSION_GRANTED && telephoneAccountData != "0") {
    ...
    private void showNotification(Context context, String number, String telephoneAccountData) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setStyle(new NotificationCompat.BigTextStyle().bigText("Звонок с неизвестного номера, код - " + telephoneAccountData))
